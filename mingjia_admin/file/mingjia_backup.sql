...
INSERT INTO `course` VALUES (1,'暂无安排','暂无安排',NULL,NULL,NULL,0),(2,'17年寒假老罗新概念1班','周二17：00 周三17：00',2,2,NULL,1),(3,'2017春季许岑剑桥一班级','周一17：00 周三17：00',1,1,'这是一个备注',0),(4,'2017春季许岑剑桥一班级','周一17：00 周三17：00',1,1,'这是一个备注',0),(5,'2017春季许岑剑桥一班级','周一17：00 周三17：00',1,1,'这是一个备注',0),(6,'2017秋季王超剑桥','周三1700周日1700',11,2,'',0);
...
CREATE TABLE `school` (
  ...
  `school_address` varchar(204) DEFAULT NULL COMMENT '校区所在的详细地址的位置',
  `remark` varchar(54) DEFAULT NULL,
...
-- Dump completed on 2017-10-26 11:53:05
